...
export const Index = () => {
  ...
  //pizzza details are here like inventory
  ...
  const handleStatus = async (id) => {
    ...
    if (nextStatusIndex >= status.length) {
      console.log(
        "Next status index exceeds status array bounds:",
        nextStatusIndex
      );
  ...
  return (
    <>
      <div className="upprDAta">
        <div className="RemainBasses">
          <h5>
            Pizza Base Available <p>{inventory?.bases}</p>
          </h5>
        </div>
        <div className="RemainVeggies">
          <h5>
            Pizza Extra ingridientes 
            <p>
              {inventory?.extras}
            </p>
          </h5>
